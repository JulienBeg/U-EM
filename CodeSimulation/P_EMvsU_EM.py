...
def metrics_PEM(ListQ=[10,20,30],File="test.txt",sigma=1,NbIter=1000,QP=300):
    ...
    for Q in ListQ:
        ...
        for i in range(NbIter):
            ...
            ProfilingTrace,ProfilingText = trace_for_profiling(secret_a1,secret_a2,sigma,QP=QP)
